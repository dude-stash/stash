...
import { CreateLinkPerformerDialog } from "src/components/Shared/ScrapeDialog/CreateLinkPerformerDialog";
...
export function useScrapedPerformers(
  ...
  const [linkedPerformer, setLinkedPerformer] =
    useState<GQL.ScrapedPerformer | null>(null);
  ...
  const scrapedPerformersRow = (
    <ScrapedPerformersRow
      ...
      onLinkExisting={(l) => setLinkedPerformer(l)}
