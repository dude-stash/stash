...
export interface IUIConfig {
  ...
  // if true, deleting a scene from the scene player page loads the next scene
  // in the queue instead of returning to the previous page
  playNextOnDelete?: boolean;
